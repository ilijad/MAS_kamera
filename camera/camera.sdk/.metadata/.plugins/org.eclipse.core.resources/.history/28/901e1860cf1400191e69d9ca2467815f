...
struct regval_list a[] = {//from the linux driver
	{ REG_COM7, COM7_RESET },
...
struct regval_list c[] = {//from the linux driver
	{ REG_COM7, COM7_RESET },
