...
rst -processor
targets -set -nocase -filter {name =~ "ARM*#0" && jtag_cable_name =~ "Xilinx PYNQ-Z1 003017A4CE72A"} -index 0
dow C:/Programiranje/ProgramiMAS/Projekt/MAS_kamera/camera/camera.sdk/standalone_bsp_0_xilffs_polled_example_2/Debug/standalone_bsp_0_xilffs_polled_example_2.elf
