...
int main()
{
   ...
   XGpio_SetDataDirection(&input, 2, 0x0);			//set second channel tristate buffer to input
   ...
   while(1){
      ...
      if(button_data == 0b0000){} //do nothing
    	  ...
    	  xil_printf("button 0 pressed\n\r");
      	  XGpio_DiscreteWrite(&input, 2, 0b0001);
   }
      else if(button_data == 0b0010){
         xil_printf("button 1 pressed\n\r");
         XGpio_DiscreteWrite(&input, 2, 0b0010);
      }
      else if(button_data == 0b0100){
         xil_printf("button 2 pressed\n\r");
         XGpio_DiscreteWrite(&input, 2, 0b0100);
      }
      else if(button_data == 0b1000){
         xil_printf("button 3 pressed\n\r");
         XGpio_DiscreteWrite(&input, 2, 0b1000);
      }
      else{
         xil_printf("multiple buttons pressed\n\r");
         XGpio_DiscreteWrite(&input, 2, 0b1111);
      }
      usleep(200000);			//delay
