...
entity design_1_wrapper is
  port (
    ...
    iic_0_tri_io : inout STD_LOGIC_VECTOR ( 2 downto 0 );
...
architecture STRUCTURE of design_1_wrapper is
  ...
  port (
    ...
    camera_tri_i : in STD_LOGIC_VECTOR ( 10 downto 0 );
    iic_0_tri_i : in STD_LOGIC_VECTOR ( 2 downto 0 );
    iic_0_tri_o : out STD_LOGIC_VECTOR ( 2 downto 0 );
    iic_0_tri_t : out STD_LOGIC_VECTOR ( 2 downto 0 )
  );
  ...
  signal iic_0_tri_i_0 : STD_LOGIC_VECTOR ( 0 to 0 );
  signal iic_0_tri_i_1 : STD_LOGIC_VECTOR ( 1 to 1 );
  signal iic_0_tri_i_2 : STD_LOGIC_VECTOR ( 2 to 2 );
  signal iic_0_tri_io_0 : STD_LOGIC_VECTOR ( 0 to 0 );
  signal iic_0_tri_io_1 : STD_LOGIC_VECTOR ( 1 to 1 );
  signal iic_0_tri_io_2 : STD_LOGIC_VECTOR ( 2 to 2 );
  signal iic_0_tri_o_0 : STD_LOGIC_VECTOR ( 0 to 0 );
  signal iic_0_tri_o_1 : STD_LOGIC_VECTOR ( 1 to 1 );
  signal iic_0_tri_o_2 : STD_LOGIC_VECTOR ( 2 to 2 );
  signal iic_0_tri_t_0 : STD_LOGIC_VECTOR ( 0 to 0 );
  signal iic_0_tri_t_1 : STD_LOGIC_VECTOR ( 1 to 1 );
  signal iic_0_tri_t_2 : STD_LOGIC_VECTOR ( 2 to 2 );
...
design_1_i: component design_1
     port map (
      ...
      iic_0_tri_i(2) => iic_0_tri_i_2(2),
      iic_0_tri_i(1) => iic_0_tri_i_1(1),
      iic_0_tri_i(0) => iic_0_tri_i_0(0),
      iic_0_tri_o(2) => iic_0_tri_o_2(2),
      iic_0_tri_o(1) => iic_0_tri_o_1(1),
      iic_0_tri_o(0) => iic_0_tri_o_0(0),
      iic_0_tri_t(2) => iic_0_tri_t_2(2),
      iic_0_tri_t(1) => iic_0_tri_t_1(1),
      iic_0_tri_t(0) => iic_0_tri_t_0(0),
...
iic_0_tri_iobuf_0: component IOBUF
     port map (
      I => iic_0_tri_o_0(0),
      IO => iic_0_tri_io(0),
      O => iic_0_tri_i_0(0),
...
iic_0_tri_iobuf_1: component IOBUF
     port map (
      I => iic_0_tri_o_1(1),
      IO => iic_0_tri_io(1),
      O => iic_0_tri_i_1(1),
...
iic_0_tri_iobuf_2: component IOBUF
     port map (
      I => iic_0_tri_o_2(2),
      IO => iic_0_tri_io(2),
      O => iic_0_tri_i_2(2),
