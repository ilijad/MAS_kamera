...
proc create_root_design { parentCell } {
  ...
  set iic_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 iic_0 ]
  ...
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO2 [get_bd_intf_ports iic_0] [get_bd_intf_pins axi_gpio_1/GPIO2]
